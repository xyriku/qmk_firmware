...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // Acts as cmd for any unbound keys.  c
    ...
    [_ADJUST] = LAYOUT_planck_grid(
            MD_CODE, UG_VALU, UG_VALD, UG_TOGG, UG_SPDU, UG_HUEU, UG_SATU, _______, _______, _______, _______, GAME,
            _______, RGB_SAI, RGB_SAD, UG_NEXT, UG_SPDD, UG_HUED, UG_SATD, _______, _______, _______, _______, _______,
